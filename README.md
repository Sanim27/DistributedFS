...
```
Starting servers...
Uploading hello.txt to distributed network...
✓ File 'hello.txt' successfully uploaded to all nodes!
  - Stored in :3000_network/[node_id]/...
  - Stored in :4000_network/[node_id]/...
  - Stored in :5000_network/[node_id]/...
```
